...
class AttributeController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$attribute) {
            return $this->responseRedirectBack('Error ocurre while creating attribute.', 'error', true, true);

        }

        return $this->responseRedirect('admin.attributes.index', 'Attribute added successsfully', 'success', false, false);
